...
object RateSpanSampler {
  ...
  def create[F[_]: Concurrent: Temporal](bucketSize: Int, tokenRate: Double): Resource[F, SpanSampler[F]] =
  ...
  def create[F[_]: Concurrent: Temporal](bucketSize: Int, tokenInterval: FiniteDuration): Resource[F, SpanSampler[F]] =

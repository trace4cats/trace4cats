...
object Dependencies {
  object Versions {
    ...
    val fs2 = "2.5.0"
    val fs2Kafka = "1.1.0"
    val googleCredentials = "0.22.2"
    val googleCloudTrace = "1.2.10"
    val grpc = "1.34.1"
    val http4s = "0.21.15"
    val http4sJdkClient = "0.3.3"
    val jaeger = "1.5.0"
    val jwt = "3.12.0"
    val kafka = "2.7.0"
    val kittens = "2.2.1"
    ...
    val sttpClient3 = "3.0.0-RC13"
    val sttpModel = "1.2.0-RC11"
    val sttpTapir = "0.17.1"
    val svm = "19.2.1"
    val vulcan = "1.2.0"
